...
try {
  ...
  const serviceAccount = JSON.parse(
    readFileSync('./gym-managment-aa0a1-firebase-adminsdk-fbsvc-66a43312d0.json', 'utf8')
  );
  ...
  if (error.code === 16 || error.message.includes('UNAUTHENTICATED')) {
    ...
    console.error('   https://console.firebase.google.com/project/gym-managment-aa0a1/settings/serviceaccounts/adminsdk');
    console.error('');
    console.error('2. Make sure Firestore is enabled in Firebase Console:');
    console.error('   https://console.firebase.google.com/project/gym-managment-aa0a1/firestore');
    console.error('');
    ...
    console.error('   Make sure the service account has "Firebase Admin" or "Cloud Datastore User" role');
  }
